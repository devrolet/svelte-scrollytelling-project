...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas_1, "class", "svelte-zw90x5");
    			add_location(canvas_1, file$2, 119, 0, 4390);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function updateCanvas(step) {
    		...
    		switch (stepIndex) {
    			case 1:
    				// Example: Zoom in on specific area for step 2 - will adjust to exact position later
    				ctx.drawImage(mapImage, 300, 800, 300, 200, 0, 0, canvas.width, canvas.height);
    				// targetZoom = { x: 300, y: 800, width: canvas.width, height: canvas.height };
    				break;
    			case 2:
    				ctx.drawImage(mapImage, 300, 800, 300, 200, 0, 0, canvas.width, canvas.height);
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div0 = element("div");
    			div0.textContent = "Section 1 Content";
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "Section 2 Content";
    			t3 = space();
    			div2 = element("div");
    			div2.textContent = "Section 3 Content";
    			t5 = space();
    			div3 = element("div");
    			div3.textContent = "Section 4 Content";
    			attr_dev(div0, "class", "section svelte-12c3vvb");
    			add_location(div0, file$1, 12, 4, 335);
    			attr_dev(div1, "class", "section svelte-12c3vvb");
    			add_location(div1, file$1, 13, 4, 384);
    			attr_dev(div2, "class", "section svelte-12c3vvb");
    			add_location(div2, file$1, 14, 4, 433);
    			attr_dev(div3, "class", "section svelte-12c3vvb");
    			add_location(div3, file$1, 15, 4, 482);
    		},
    		m: function mount(target, anchor) {
