...
var app = (function () {
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(canvas_1, "class", "svelte-18zc8t8");
    			add_location(canvas_1, file$2, 118, 0, 4717);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	function updateCanvas(step) {
    		...
    		switch (stepIndex) {
    			...
    			case 2:
    				...
    				ctx.closePath();
    				$$invalidate(2, ctx.fillStyle = 'rgba(255, 255, 255, 0.9)', ctx);
    				ctx.fill();
    				// Add text
    				$$invalidate(2, ctx.font = 'bold 60px Arial', ctx);
    				$$invalidate(2, ctx.fillStyle = "#FFF", ctx);
    				$$invalidate(2, ctx.textAlign = 'left', ctx);
    				$$invalidate(2, ctx.textBaseline = 'middle', ctx);
    			...
    			case 3:
    				...
    				const smPolygonPoints = [
    					{
    						x: 450, // Set the font style and size
    						// Set the text color
    				...
    				ctx.fill();
    				// Add text
    				$$invalidate(2, ctx.font = 'bold 18px Arial', ctx);
    				$$invalidate(2, ctx.fillStyle = "#FFF", ctx);
    				$$invalidate(2, ctx.textAlign = 'left', ctx);
    				$$invalidate(2, ctx.textBaseline = 'middle', ctx);
    				// Calculate the approximate position for the text
    			...
    			case 4:
    				...
    				const rectangles = [
    					{
    						x: 520, // Set the font style and size
    						// Set the text color
    						// Align text horizontally
    						// Align text vertically
    						y: 530,
    				...
    				rectangles.forEach(rect => {
    					$$invalidate(2, ctx.fillStyle = 'rgba(255, 255, 255, 0.8)', ctx);
    	...
    	$$self.$$.on_mount.push(function () {
    		if (stepIndex === undefined && !('stepIndex' in $$props || $$self.$$.bound[$$self.$$.props['stepIndex']])) {
    			console.warn("<CanvasComponent> was created without expected prop 'stepIndex'");
    		}
    	});
    ...
    function create_foreground_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h10, file$1, 17, 16, 453);
    			add_location(p0, file$1, 18, 16, 496);
    			attr_dev(section0, "class", "svelte-1xs1kvx");
    			add_location(section0, file$1, 16, 12, 427);
    			add_location(h11, file$1, 21, 16, 879);
    			add_location(p1, file$1, 22, 16, 922);
    			attr_dev(section1, "class", "svelte-1xs1kvx");
    			add_location(section1, file$1, 20, 12, 853);
    			add_location(h12, file$1, 25, 16, 1305);
    			add_location(p2, file$1, 26, 16, 1348);
    			attr_dev(section2, "class", "svelte-1xs1kvx");
    			add_location(section2, file$1, 24, 12, 1279);
    			add_location(h13, file$1, 29, 16, 1731);
    			add_location(p3, file$1, 30, 16, 1774);
    			attr_dev(section3, "class", "svelte-1xs1kvx");
    			add_location(section3, file$1, 28, 12, 1705);
    			attr_dev(div0, "class", "scroll-container svelte-1xs1kvx");
    			add_location(div0, file$1, 15, 8, 384);
    			attr_dev(div1, "slot", "foreground");
    			add_location(div1, file$1, 14, 4, 352);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_background_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 34, 4, 2149);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	/*scroller_1_binding*/ ctx[3](scroller_1);
    	scroller_1.$on("section", /*section_handler*/ ctx[4]);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const section_handler = event => changeStep(event.detail);
    	...
    	return [stepIndex, scroller, changeStep, scroller_1_binding, section_handler];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-u1481v");
    			add_location(main, file, 13, 0, 231);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
